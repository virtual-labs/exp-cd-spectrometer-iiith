...
F is a series of 45¢X quartz plates to clean further the monochromatic exit beam polarization

CDM is the photoelastic modulator crystal in its thermostatted housing, it acts (in CD mode) as a 1/4 wave achromatic plate, i.e. the linear polarized beam is deflected + and ¡V 45¢X at the crystal oscillation frequency (50 KHz)
